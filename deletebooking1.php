...
<?php
if(isset($_POST['todeletebooking'])){

    $deletebooking = $_POST['todeletebooking'];
    ...
    if(($row4['savail']==$usavail) && ($row4['sbooked']==$usbooked)){
        ...
        if($result1 == FALSE){
            ...
            <form action="viewallbookingforc.php" method="post">
            <button class="btn123" value="<?php echo $bookcid ; ?>" name="toviewallbookingforc">NEXT</button>
            </form>
